...
if __name__ == "__main__":
	...
	params['file_ghg']='ghg_HAPPI2p0_v2'
	...
	restarts_list='batch_lists/batch_640_restarts.csv'
...
#        		params['file_sst']='ALLclim_ancil_14months_OSTIA_sst_'+str(year)+'-12-01_'+str(year+2)+'-01-30'
                        params['file_sst']='HAPPI20C_ancil_146months_OSTIA_sst_MMM_2088-12-01_2101-01-30'
#                        params['file_sice']='ALLclim_ancil_14months_OSTIA_ice_'+str(year)+'-12-01_'+str(year+2)+'-01-30'
		        params['file_sice']='HAPPI20C_ancil_146months_NEIL_ice_MMM_2088-12-01_2101-01-30'
	...
	# Add in batch tags:
	batch={}
	batch['name']="WAH2 ANZ50 HAPPI2 2nd gen 2090-2100"
	batch['desc']="2nd gen WAH2 ANZ50 HAPPI2 2090-2100 (starting Aug 2090)"
	batch['owner']="Suzanne Rosier <suzanne.rosier@niwa.co.nz>,Sarah Sparrow <sarah.sparrow@oerc.ox.ac.uk>"
	batch['tech_info']="6 initial condition perturbations per restart per year, 40 restarts per year from batch 640, forced by OSTIA SSTs and sea-ice"
	...
	######## Write out the file ########
        ...
        xml_out='wu_wah2_'+region+'_HAPPI2_gen2_'+Vars.site+str(first_year)+'-' + str(params['model_start_year']) + "_" +\
